		...
		vector<double> getEnergy(const vector<double>& position_x, const vector<double>& velocity_x){
			...
			for (int i=0; i<number_particles; i++){
				...
				if (i==number_particles-1){
					if (a != 0.0){potential_energy += 0.5*a*(position_x[i] - position_x[0])*(position_x[i] - position_x[0]);}
					if (b != 0.0){potential_energy += 1.0/3.0*b*(position_x[i] - position_x[0])*(position_x[i] - position_x[0])*(position_x[i] - position_x[0]);}
					if (c != 0.0){potential_energy += 0.25*c*(position_x[i] - position_x[0])*(position_x[i] - position_x[0])*(position_x[i] - position_x[0])*(position_x[i] - position_x[0]);}
				}
				else{
