...
double set_q0(const int& potential_type, const double& x){
	double q0;
	if (potential_type == 1){q0=std::exp(-0.5*x*x);}
	else if (potential_type == 2){q0=std::exp(-0.5*x*x);}
	else if (potential_type == 3){q0=std::exp(-0.5*x*x);}
...
double set_p0(const int& potential_type, const double& x){
	double p0;
	if (potential_type == 1){p0=0.0;}
	else if (potential_type == 2){p0=0.0;}
	else if (potential_type == 3){p0=0.0;}
